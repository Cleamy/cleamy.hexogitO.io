...
<img src="/img/assets/image-20230318130732097.png" style="zoom: 50%;" />

##### 中断

![](/img/assets/image-20230319095341322.png)
...
- 由 CPU 将数放入内存
     ...
     ​									　　　　<img src="/img/assets/image-20230319101734993.png" style="zoom:50%;display: block;margin: 0 auto;" />
...
　　　​												<img src="/img/assets/image-20230319101818583.png" style="zoom:50%;" />
...
​															<img src="/img/assets/image-20230319102851592.png" style="zoom:50%;" />
...
​																	<img src="/img/assets/image-20230320140213389.png" style="zoom:50%;" />
...
### 软件质量模型
<img src="/img/assets/1685074637082-03033021-2e2d-4fbb-a74f-0afb51fc7495.png" style="zoom: 67%;" />
...
1. 结构事物：结构事物是UML模型中的**名词**，通常是模型的**静态部分**，描述概念或物理元素。
   ...
   ​		<img src="/img/assets/image-20230409092847753.png" style="zoom:80%;" /> 

2. 行为事物：行为事物是UML模型的**动态部分**，它们是模型中的**动词**，描述了跨越时间和空间的行为。

   ​		<img src="/img/assets/image-20230409092904254.png" style="zoom:80%;" /> 

3. 分组事物：分组事物是UML模型的**组织部分**，是一些由模型分解成“盒子”。

   ​													<img src="/img/assets/image-20230409093138336.png" style="zoom:80%;" /> 

4. 注释事物：注释事物是UML模型的解释部分。这些注释事物用来描述、说明和标注模型的任何元素。

   ​												<img src="/img/assets/image-20230409093316591.png" style="zoom:80%;" /> 
...
1. 依赖：依赖是两个事物间的**语义关系**，其中一个事物（独立事物）发生变化会影响另一个事物（依赖事物）的语义。
   ...
   ​			<img src="/img/assets/image-20230409095010416.png" style="zoom:80%;" /> 
   ​				<img src="/img/assets/image-20230409095211029.png" style="zoom:80%;" /> 

2. 关联：关联是一种**结构关系**，它描述了一组链，链是对象之间的连接。
   ![](/img/assets/image-20230409095312439.png) 

   -  聚合：部分和整体的生命周期不一致，整体消失了，部分仍然存在，部分可以脱离整体存在。 ![](/img/assets/image-20230409100146317.png) 
   -  组合：部分和整体的生命周期一致，整体消失了，部分也消失了，部分不可以脱离整体存在。 ![](/img/assets/image-20230409100242135.png) 

3. 泛化：泛化是一种特殊/一般关系，特殊元素（子元素）的对象可替代一般元素（父元素）的对象。子元素共享了父元素的结构和行为。 ![](/img/assets/image-20230409100634668.png) 

4. 实现（了解）：实现是类元之间的语义关系，其中一个类元指定了由另一个类元保证执行的契约。 ![](/img/assets/image-20230409101019308.png) 
...
​										<img src="/img/assets/1685076961406-e231bd41-5363-4450-b54e-a54309c0ca1f.png" alt="image.png" style="zoom:50%;" />
...
![](/img/assets/1685076987965-4eb8a665-addc-4c1c-b5e9-d8be10efe4b0.png)
...
![](/img/assets/1685077023148-90ee2ff1-8953-4b90-9477-933822d2bfdd.png)
#### 交互图
...
1.  **序列图**（顺序图、时序图） ：序列图是场景的图形化表示，描述了以时间顺序组织的对象之间的交互活动。
   ...
   - 序列图有控制焦点
     ...
     ![](/img/assets/1685077053930-8b8cd48a-5630-4c44-bcf4-0e75c834b214.png)
...
![](/img/assets/1685077109313-f06ed824-0232-4854-80ba-768c8fd969ed.png)
#### 🔺状态图
...
事件，监护条件，动作
![](/img/assets/202306082348213.png)
**事件触发转换（迁移)**
...
​												<img src="/img/assets/1685077163333-295177ac-f4ad-4a95-a65d-9dc2236c6395.png" style="zoom: 50%;" />
...
​												<img src="/img/assets/image-20230411155910646.png" style="zoom:67%;" />
​						<img src="/img/assets/1685077213263-61f53031-dd07-45bd-85e1-97d4dd9a4ebe.png" style="zoom: 67%;" />
...
部署图展现了系统的软件和硬件之间的关系，在实施阶段使用。
												<img src="/img/assets/1685077237730-1e8c994a-45de-465b-808e-282db502f286.png" style="zoom:67%;" />
...
​						<img src="/img/assets/image-20230417151608470.png" style="zoom:50%;" />
...
​																<img src="/img/assets/image-20230414101050042.png" style="zoom:50%;" />
...
​													<img src="/img/assets/image-20230414103527217.png" style="zoom:50%;" />
...
![](/img/assets/image-20230414113152451.png)
...
![](/img/assets/image-20230414134325945.png)
...
![](/img/assets/image-20230414145403104.png)
...
![](/img/assets/image-20230414153516687.png)
...
![](/img/assets/image-20230414154430890.png)
...
![](/img/assets/image-20230414161840751.png)
...
![](/img/assets/image-20230414163901596.png)
...
​		<img src="/img/assets/image-20230415091034585.png" style="zoom: 67%;" />
...
![](/img/assets/image-20230415103943593.png)
...
![](/img/assets/image-20230415135923577.png)
...
​		<img src="/img/assets/image-20230415145022868.png" style="zoom:67%;" />
...
![](/img/assets/image-20230415154708049.png)
...
​						<img src="/img/assets/image-20230415171040969.png" style="zoom: 67%;" />
...
![](/img/assets/image-20230415173855870.png)
...
​									<img src="/img/assets/image-20230416093633395.png" style="zoom:67%;" />
...
​				![](/img/assets/image-20230416103420119.png)
...
![](/img/assets/image-20230416112456694.png)
...
![](/img/assets/image-20230416150625243.png)
...
![](/img/assets/image-20230416165012628.png)
...
​									![](/img/assets/image-20230417082353859.png)
...
![](/img/assets/image-20230417110447963.png)
...
![](/img/assets/image-20230417112937358.png)
...
​											<img src="/img/assets/image-20230417135729720.png" style="zoom: 50%;" />
...
属于 3NF 的关系模式 R 可能存在主属性对码的部分依赖和传递依赖。
								<img src="/img/assets/202306082348988.png" style="zoom: 50%;" />
...
### 协议簇
​										<img src="/img/assets/1685079630978-b652f779-54ff-4718-8113-e4692be411a9.png" style="zoom:50%;" />
​												<img src="/img/assets/1685079609574-90013942-1227-46ba-b363-9c059875d831.png" style="zoom:50%;" />
...
![](/img/assets/image-20230402155323603.png)
...
![](/img/assets/image-20230402211553041.png)
...
​																<img src="/img/assets/202304122204974.png" style="zoom: 80%;" />
